#.rst:
# MutantConfigureHeader
# ---------------------
#
# CMake command for generating an output C/C++ header from an input file. To be
...
if(_MUTANT_CONFIGURE_HEADER_DEFINED)
    return()
endif()
set(_MUTANT_CONFIGURE_HEADER_DEFINED TRUE)

function(MUTANT_CONFIGURE_HEADER)
endfunction()
